...
const TableIcon = (props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg fill="currentColor" {...props} viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
